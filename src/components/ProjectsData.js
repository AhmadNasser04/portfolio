...
export const projects = [
  {
    ...
    time: "2 days",
    description:
      "Want to test your speed? Well you can do it here! What speed you ask? Well, any, from internet speed to cps speed we have it all",
    technologies: [
      ["React", reactLogo],
  ...
  },
  {
    ...
    time: "1 day",
    description:
      "A fun little website to do quizzes, new quizzes can be added easily!",
    technologies: [
      ["React", reactLogo],
      ["Tailwindcss", tailwind],
      ["Firebase", firebase],
  ...
  },
  {
    ...
    time: "4 days",
    description:
      "A fun tictactoe game with local multiplayer, the bot may also be unbeatable, you can test your luck with that one ;D",
    technologies: [
      ["Nextjs", next],
      ["Tailwindcss", tailwind],
      ["Firebase", firebase],
  ...
  },
  {
    ...
    time: "1 week",
    description:
      "An amazing ecommer app made with React, Redux Toolkit, Strapi, and mui, with stripe integration",
    technologies: [
      ["React", reactLogo],
      ["Redux Toolkit", redux],
      ["Tailwindcss", tailwind],
